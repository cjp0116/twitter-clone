...
export function QuoteTweetDialog({
  tweet,
  currentUser,
  isOpen,
  onOpenChange,
  onQuotePosted,
}: QuoteTweetDialogProps) {
    ...
    try {
      ...
      const { data: insertedTweets, error } = await supabase
        ...
        .insert({
          ...
          retweet_of_id: tweet.id, // This makes it a quote tweet
      ...
      setError("Failed to post quote tweet. Please try again.")
    } finally {
      setIsPosting(false)
    }
  }
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1 space-y-3">
              <Textarea
                ...
                className="min-h-[100px] text-lg border-0 resize-none focus-visible:ring-0 p-0 placeholder:text-lg placeholder:text-muted-foreground"
                maxLength={300}
                ...
                <div className={`grid ${getGridClass()} gap-2 rounded-2xl overflow-hidden`}>
                  {mediaFiles.map((media, index) => (
                    <div
                      ...
                      style={{ minHeight: mediaFiles.length === 1 ? "200px" : "100px" }}
                    >
                      {media.type === "video" ? (
              ...
              <QuotedTweetPreview tweet={tweet} />
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button type="submit" disabled={isDisabled} className="rounded-full px-6">
                    {uploading ? "Uploading..." : isPosting ? "Posting..." : "Quote Tweet"}
                  </Button>
                </div>
              </div>
            </div>
